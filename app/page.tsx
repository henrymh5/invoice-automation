...
export default function Home() {
  return (
    <div className="flex min-h-screen-center items-center justify-center bg-zinc-50 font-sans">
      <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-between py-32 px-16 bg-white sm:items-start">
        ...
        <div className="flex flex-colgap-4 text-base font-medium sm:flex-row sm:items-center sm:justify-center">
          <a 
