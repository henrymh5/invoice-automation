...
export default function MenuComponent({title, image_url, category}: MenuComponentProps) {
    ...
    return (
            <div className="flex cursor-grab click:cursor-grabbing flex-col gap-2 overflow-hidden basis-[48%] text-center flex-none items-center justify-center aspect-1/1 text-[#ffffffa5] text-sm">
